...
class LocationTextStyle{
  ...
  static final regularWhiteTextStyle = baseTextStyle.copyWith(color: Colors.white70,
  fontSize: 13);
  ...
  static final priceGreyTextStyle =
    baseTextStyle.copyWith(color: Colors.grey, fontSize: 13);

  static final regularGreyTextStyle =
    baseTextStyle.copyWith(color: Colors.grey, fontSize: 13);

  static final boldTextStyle = baseTextStyle.copyWith(fontWeight: FontWeight.bold, fontSize: 16);
